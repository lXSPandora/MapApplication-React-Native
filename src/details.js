...
import { Container, Content, Card, CardItem, Thumbnail, Button, Icon, Text, Right, Left, Body } from 'native-base';
            ...
            <Card>
                ...
                <CardItem>
                  <Left>
                    ...
                    <Body>
                      <Text>Owner:</Text>
                      <Text style={{ fontSize: 14}}>{params.owner}</Text>
                    </Body>
                  </Left>
                </CardItem>
                <CardItem>
                  <Left>
                    ...
                    <Body>
                      ...
                      <Text style={{ fontSize: 14}}>{params.visit}</Text>
                    </Body>
                  </Left>
                </CardItem>
           </Card>
